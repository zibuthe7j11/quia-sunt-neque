...
```js
const tildify = require('@zibuthe7j11/quia-sunt-neque');
...
See [un@zibuthe7j11/quia-sunt-neque](https://github.com/mehmetcanfarsak/un@zibuthe7j11/quia-sunt-neque) for the inverse.
